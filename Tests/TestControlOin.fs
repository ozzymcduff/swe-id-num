...
let ``character_oin_ctrl`` ()=
    tryParse "556000-4615" |> successFull |> control |> should equal true
    tryParse "232100-0156" |> successFull |> control |> should equal true
//    tryParse "802002-4280" |> successFull |> control |> should equal true
//    tryParse "556000-4617" |> successFull |> control |> should equal true
//    tryParse "232100-0152" |> successFull |> control |> should equal true
    tryParse "802002-4281" |> successFull |> control |> should equal false
